...
<div x-data="{ 
    ...
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Recurring Issues</h1>
        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Incidents sorted by occurrence count</p>
    </div>

    <!-- Filters -->
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 mb-6">
        <form method="GET" action="{{ route('dashboard.recurring') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                @forelse($incidents as $incident)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <span class="px-3 py-1 text-sm font-bold rounded-full bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">
                            {{ $incident->updated_at->format('M d, Y H:i') }}
                        </td>
                    </tr>
                @empty
                    <tr>
